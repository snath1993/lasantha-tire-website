...
export const CalendarView: React.FC<CalendarViewProps> = ({ selectedDate, onSelectDate }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 select-none shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="p-1 hover:bg-gray-100 rounded-lg disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
          >
