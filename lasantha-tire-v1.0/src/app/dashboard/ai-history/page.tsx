...
import { Search, Bot, User, Calendar, MessageSquare } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white tracking-tight">AI Chat History</h2>
              <p className="text-slate-400 text-sm">Review automated conversations and interactions</p>
            </div>
          </div>
