...
function JobsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-20 md:pb-10 w-full overflow-x-hidden">
      {error && (
      ...
      <div className="sticky top-0 z-30 w-full px-6 py-3 md:px-6 md:py-6">
      ...
      {/* Content Grid */}
      <div className="w-full md:max-w-7xl md:mx-auto px-3 md:px-8 py-4 md:py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 md:gap-4 w-full">
          {filteredJobs.map(([id, job]) => (
            <div 
              key={id}
              className={`group relative bg-slate-900 rounded-2xl border transition-all duration-300 w-full max-w-full overflow-hidden ${
                job.enabled 
