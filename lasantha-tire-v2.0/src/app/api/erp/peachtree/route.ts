...
export async function GET(request: Request) {
  ...
  try {
    /* 
       REMOVED: Redundant call to /api/peachtree-direct which was just proxying to the bridge anyway.
       This was causing performance issues and dependency on port 3028 (v1.5).
       Now we go directly to the Python Bridge.
    */
