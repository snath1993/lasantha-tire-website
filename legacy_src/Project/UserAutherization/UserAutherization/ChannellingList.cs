...
{
    public partial class ChannellingList : Form
    {
        public static string ConnectionString;
        public ChannellingList()
        {
            InitializeComponent();
            setConnectionString();
        }
        ...
        private void LoadCustomerList()
        {
            try
            {
                    ...
                    string s = "SELECT * FROM ViewScanChannel WHERE ItemType='CHANNELLING' ORDER BY ReceiptNo";
        ...
        private void SeachOption()
        {
            try
            {
                    ...
                    if (!(cmbSearchby.SelectedIndex == 5))
                    {
                        ...
                        s = "SELECT * FROM ViewScanChannel WHERE " + StrCode + " LIKE '%" + txtSearch.Text + "%' AND ItemType='CHANNELLING'  ORDER BY ReceiptNo";
                   ...
                   {
                        s = "SELECT * FROM ViewScanChannel WHERE Consultant LIKE '%" + txtSearch.Text + "%' AND ItemType='CHANNELLING' AND Date='"+ dtpSearchDate.Value.ToString("MM/dd/yyyy") + "' ORDER BY ReceiptNo";
        ...
        private void btnSearchByDate_Click(object sender, EventArgs e)
        {
                ...
                s = "SELECT * FROM ViewScanChannel WHERE Date ='" + dtpSearchDate.Value.ToString("MM/dd/yyyy") + "'AND ItemType='CHANNELLING' ORDER BY ReceiptNo";
