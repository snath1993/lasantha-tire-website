...
{
    public partial class LabList : Form
    {
        ...
        private void LoadCustomerList()
        {
            try
            {
                    ...
                    string s = "SELECT * FROM ViewScanChannel WHERE ItemType='LAB'   ORDER BY ReceiptNo";
        ...
        private void SeachOption()
        {
            try
            {
                    ...
                    if (cmbSearchby.Text.Trim() != "")
                    {
                        ...
                        s = "SELECT * FROM ViewScanChannel WHERE " + StrCode + " LIKE '%" + txtSearch.Text + "%' AND ItemType='LAB'  ORDER BY ReceiptNo";
        ...
        private void btnSearchByDate_Click(object sender, EventArgs e)
        {
                ...
                s = "SELECT * FROM ViewScanChannel WHERE Date ='" + dtpSearchDate.Value.ToString("MM/dd/yyyy") + "'AND ItemType='LAB' ORDER BY ReceiptNo";
