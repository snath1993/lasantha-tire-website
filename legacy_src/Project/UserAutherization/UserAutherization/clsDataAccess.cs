    ...
    public class clsDataAccess
    {
        ...
        private void GetDataFromTextFile()
        {
            try
            {
                ...
                //string kk = "Regpbss@2013Sage50Madura";//VaMGEWkEBdn9NeyVpDWBXVMUfPiTMBkMPhTlFR8Hztk=
                //string abc = objclsCommon.encryptPassword(kk);

                UserID = objclsCommon.decryptPassword(tr.ReadLine());//Iv0ys3FzCODs6aoawXFX03CgIimGmjSV
