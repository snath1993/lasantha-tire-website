...
{
    public partial class frmItemUnitCost : Form
    {
        ...
        public frmItemUnitCost(string ItemDesc)
        {
        ...
        public frmItemUnitCost(int _IsFind)
        {
            InitializeComponent();
            setConnectionString();
        ...
        private void frmCustomerList_Load(object sender, EventArgs e)
        {
            ...
            // CheckBox = "";
            txtDescriptionSearch.Text = StrItemDesc;
            ItemMasterSearch();
            SETSerchCombo();
            SetCustomFields();
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if (dgvSearchCustomer.Rows[i].Cells[3].Value.ToString() != "MAXXIES")
                        {
                            dgvSearchCustomer.Rows[i].Cells[5].Value = (Convert.ToDouble(dt.Rows[i].ItemArray[4].ToString()) + 500).ToString("N0");
                        }
                        else
                        {
